# -*- coding: utf-8 -*-
"""
Created on Tue Jan 29 11:44:03 2019
...
classifier.add(Dense(units = 150, kernel_initializer = 'uniform', activation = 'relu', input_dim = 21))
